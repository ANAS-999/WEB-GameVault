...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  return (
    <header className="w-full bg-transparent px-6 lg:px-10 pt-6 pb-2 select-none">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          <div className="w-9 h-9 rounded-xl bg-[#18181c] border border-[#27272a] flex items-center justify-center text-white group-hover:scale-105 transition-transform shadow-sm">
        ...
        <div className="flex items-center">
          {user ? (
            <div className="flex items-center gap-2 h-8 pl-1.5 pr-2.5 bg-[#141417] hover:bg-[#18181c] border border-[#27272a] hover:border-[#3f3f46] rounded-full transition-all cursor-pointer shadow-sm group">
              ...
              <span className="text-xs font-bold text-white max-w-[90px] truncate tracking-tight">
                {displayName}
              </span>
            ...
            <button
              onClick={onOpenAuth}
              className="flex items-center gap-1.5 h-8 px-4 bg-white hover:bg-[#e4e4e7] text-black text-xs font-extrabold rounded-full transition-all shadow-sm hover:scale-105"
            >
